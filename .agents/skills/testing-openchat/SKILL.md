...
- Unset inherited OPENAI_API_KEY, OPENAI_BASE_URL, OPENCHAT_DATA_DIR, OPENCHAT_HISTORY_DB_PATH, and CORS_ALLOW_ORIGINS for the backend process to isolate first-run behavior.
